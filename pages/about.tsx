      ...
      <div className='column'>
        ...
        <div>
          ...
          <p>
            ...
            modern web apps using the best technology out there. This project combines the power of GraphQL,
            Postgres as a backend, and the flexibility of Next.js for SSG or SSR—all to make lightning-fast apps
